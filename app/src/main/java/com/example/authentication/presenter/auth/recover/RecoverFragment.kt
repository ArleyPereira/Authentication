...
import com.example.authentication.databinding.FragmentRecoverBinding
        ...
        recoverViewModel.recover(email).observe(viewLifecycleOwner) { stateView ->
            when (stateView) {
                ...
                is StateView.Sucess -> {
                    ...
                    showBottomSheet(message = getString(R.string.text_message_send_email_success_recover_fragment))
                }
